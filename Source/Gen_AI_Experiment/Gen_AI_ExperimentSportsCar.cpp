...
#include "Gen_AI_ExperimentSportsCar.h"
#include "Gen_AI_ExperimentSportsWheelFront.h"
#include "Gen_AI_ExperimentSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AGen_AI_ExperimentSportsCar::AGen_AI_ExperimentSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGen_AI_ExperimentSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGen_AI_ExperimentSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGen_AI_ExperimentSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGen_AI_ExperimentSportsWheelRear::StaticClass();
