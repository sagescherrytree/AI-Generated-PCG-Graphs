...
#include "Gen_AI_ExperimentOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class GEN_AI_EXPERIMENT_API AGen_AI_ExperimentOffroadCar : public AGen_AI_ExperimentPawn
{
	GENERATED_BODY()
