...
#include "Gen_AI_ExperimentOffroadCar.h"
#include "Gen_AI_ExperimentOffroadWheelFront.h"
#include "Gen_AI_ExperimentOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AGen_AI_ExperimentOffroadCar::AGen_AI_ExperimentOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGen_AI_ExperimentOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGen_AI_ExperimentOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGen_AI_ExperimentOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGen_AI_ExperimentOffroadWheelRear::StaticClass();
